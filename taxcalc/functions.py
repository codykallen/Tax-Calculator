...
def CapGains(p23250, p22250, _sep, ALD_Investment_ec, ALD_StudentLoan_HC,
             e00200, e00300, e00600, e00700, e00800, e00650,
             e00900, e01100, e01200, e01400, e01700, e02000, e02100,
             e02300, e00400, e02400, c02900, e03210, e03230, e03240,
             c01000, c23650, ymod, ymod1, c00300, c00650):
    """
    CapGains function: ...
    """
    ...
    c00300 = e00300
    c00650 = e00650
    return (c01000, c23650, ymod, ymod1, c00300, c00650)
...
def AGI(ymod1, c02500, c02900, XTOT, MARS, _sep, DSI, _exact,
        II_em, II_em_ps, II_prt, n24, CTC_c,
    ...
    if II_credit_prt > 0. and c00100 > II_credit_ps[MARS - 1]:
        thresh = II_credit_ps[MARS - 1] + n24 * CTC_c / II_credit_prt
        excess = c00100 - thresh
        if _exact == 1:
            excess = 1000. * math.ceil(excess / 1000.)
        credit_phaseout = II_credit_prt * (c00100 - excess)
